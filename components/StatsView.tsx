    ...
    <div className="animate-fade-in space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Total Respuestas</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 border-l-4 border-l-green-500">
          <p className="text-xs font-bold text-green-600 uppercase tracking-widest mb-1">Duda Resuelta</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 border-l-4 border-l-red-500">
          <p className="text-xs font-bold text-red-600 uppercase tracking-widest mb-1">Duda No Resuelta</p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-gray-200">
                ...
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-widest">Resolvió</th>
